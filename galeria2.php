        ...
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div class="text-center">
                    <h2 class="fw-bold" style="color:var(--color1);">CLASES DE NATACIÓN</h2>
                    <p></p>
                </div>
                <hr style="color:var(--color3);">
                <div id="content-grid" class="pt-4">
                    <a class="img-links" data-gall="gallery01" title="CLASES DE NATACIÓN" href="./public/img/galeria/natacion1.jpg"><img src="./public/img/galeria/natacion1.jpg" class="mb-2" width="100%"></a>
                    <a class="img-links" data-gall="gallery01" title="CLASES DE NATACIÓN" href="./public/img/galeria/natacion2.jpg"><img src="./public/img/galeria/natacion2.jpg" class="mb-2" width="100%"></a>
                    <a class="img-links" data-gall="gallery01" title="CLASES DE NATACIÓN" href="./public/img/galeria/natacion3.jpg"><img src="./public/img/galeria/natacion3.jpg" class="mb-2" width="100%"></a>
                    <a class="img-links" data-gall="gallery01" title="CLASES DE NATACIÓN" href="./public/img/galeria/portada_natacion.jpg"><img src="./public/img/galeria/portada_natacion.jpg" class="mb-2" width="100%"></a>
                </div>
            </div>
        </div>
