            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-6 px-5 my-auto">
                    <div class="content-b2">
                        <h2>Nivel Inicial</h2>
                        <p>
                            El nivel inicial es la base para el desarrollo psicosocial,
                            intelectual de la persona, se estimula todas las áreas del saber
                            con La <b>METODOLOGÍA JUEGO TRABAJO, APRENDIZAJE BASADO
                                EN PROYECTOS O ABP </b> metodologías activas, que permiten el
                            desarrollo de las inteligencias múltiples, a la participación
                            activa y a la autonomía de los niños en el aula.
                        </p>
                        ...
                        <ul class="course-list">
                            <li class="course-item my-2"><i class="fas fa-check-circle"></i> Inicial 3 años (L-V): 8:00 a.m. - 12:30pm </li>
                            <li class="course-item my-2"><i class="fas fa-check-circle"></i> Inicial 4 años (L-V): 8:00 a.m. - 01:00pm </li>
                            <li class="course-item my-2"><i class="fas fa-check-circle"></i> Inicial 5 años (L-V): 8:00 a.m. - 01:30pm </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container-fluid pb-5">
            <div class="row d-flex justify-content-center">
                <div class="col-lg">
                    ...
                    <br>
                    <p>Los niños se inician en la indagación científica, mediante la
                        interacción con el medio ambiente, se cuenta con áreas verdes,
                        huerto escolar donde los niños descubren los seres vivientes
                        lombrices, plantas, otros y los seres no vivos como el suelo, las
                        piedritas, el agua.
                    </p>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row d-flex justify-content-center py-3">
                        <div class="col-lg-2 mx-4">
                            <center>
                                <div class="icon-metodologia">
                                    <img src="./public/img/icons/integral.png" alt="">
                                </div>
                            </center>
                        </div>
                        <div class="col-lg-5 my-auto">
                ...
                <div class="col-lg-6">
                    <div class="row d-flex justify-content-center py-3">
                        <div class="col-lg-2 mx-4">
                            <center>
                                <div class="icon-metodologia">
                                    <img src="./public/img/icons/multiples.png" alt="">
                                </div>
                            </center>
                            <!-- <br>
                    <h2>Misión</h2> -->
                    ...
                    <div class="row d-flex justify-content-center py-3">
                        <div class="col-lg-2 mx-4">
                            <center>
                                <div class="icon-metodologia">
                                    <img src="./public/img/icons/protagonista.png" alt="">
                                </div>
                            </center>
                            <!-- <br>
                    <h2>Misión</h2> -->
                        ...
                        <div class="col-lg-5 my-auto">
                            <p style="text-align: start;">Protagonista de su Aprendizaje.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="cursos">
        <div class="container-fluid" style="margin-top: -60px;">
            <div class="row mx-0 d-flex justify-content-center">
                        ...
                        <div class="card-body d-flex">
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-lg-7 my-auto">
                                    <h4 style="color:white;">Matemática</h4>
                                    <!-- <p>Desarrolla la creatividad y la capacidad para resolver
                                        problemas; asimismo, eleva al
                                        máximo sus capacidades intelectuales y de razonamiento
                                        lógico.
                                    </p> -->
                                </div>
                            </div>
                ...
                <div class="col-md-4 pt-5">
                    <div class="card text-white" style="background-color: var(--color6);">
