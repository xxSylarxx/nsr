...
<body>
    ...
    <section class="container lista">
        ...
        <div class="row justify-content-between mt-4" style="padding-top: 6rem;">
            <div class="col-md-8">
                <?php include_once './documentos/documento' . $_GET['id'] . '.php' ?>
