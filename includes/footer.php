    ...
    <div class="container-fluid py-4" style="padding-left:3%;padding-right:3%;">
        <div class="row ">
            <div class="col-lg-3 px-4">
                <center><img src="./public/img/icons/escudo.png" alt=""></center>
                ...
                <div class="d-flex justify-content-center">
                    <div class="col-lg-2">
                        <div style="border-radius:50%;background: var(--color2);width:40px;height:40px;padding-top:4px;">
                            <a href="https://www.instagram.com/colegio.rosario.sjl/" style="color:var(--color5);font-size:20px;" target="_blank">
                    ...
                    <div class="col-lg-2">
                        <div style="border-radius:50%;background: var(--color2);width:40px;height:40px;padding-top:4px;">
                            <a href="https://www.facebook.com/nsrosario.edu.pe" style="color:var(--color5);font-size:20px;" target="_blank">
...
<!-- <div class="bar-inf2" style="position: fixed; bottom: 60px; right: 20px; z-index: 999;">
    <a href="https://wa.me/#" target="_blank" class="text-success">
    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-start align-items-center">
                <p class="my-1 text-center" style="font-size: 15px; color:var(--color5)">© 2025 Todos los derechos reservados, Nuestra Señora del Rosario.</p>
            ...
            <div class="col d-flex justify-content-end align-items-center">
                <p class="my-1 text-center" style="font-size: 14px; color: #fff">Desarrollado por <a href="#" target="_blank" style="color: var(--color5); font-weight: bold;">Sensoft</a></p>
            </div>
        </div>
    </div>
</section>